...
public class CuentaServiceImpl implements CuentaService{
    ...
    @Override
    @Transactional
    public void transferir(Long numCuentaOrigen, Long numCuentaDestinio, BigDecimal monto, Long bancoId) {
        ...
        Cuenta cuentaDestino = cuentaRepository.findById(numCuentaDestinio).orElseThrow();
